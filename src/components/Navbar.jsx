...
const handleLogOut = () => {
  ...
  return (
    <div>
        <div className='flex bg-slate-900 justify-between  px-4 items-center py-6'>
         <Link to={'/'}><div className='font-sans text-xl text-white'> Crypto.com</div></Link>  
            <div className='flex flex-col-reverse items-center md:flex-row gap-2'>
             <div className='w-[100%] flex '><Link to={'/cart'}><button className='text-slate-900 rounded px-3 bg-white mx-3 cursor-default font-bold '>Cart : {mycart.length}</button></Link> </div>  
